...
class LanguageDe extends BaseLanguage {
  ...
  String get dontWorryItHappens =>
      'Mach dir keine Sorge! es passiert. Bitte geben Sie die mit Ihrem Konto verknüpfte E-Mail-Adresse ein';
  ...
  String get shareYourThoughtsOnYourFavoriteMovie =>
      'Teilen Sie Ihre Gedanken zu Ihrem Lieblingsfilm mit';
  ...
  String get removeFromContinueWatch =>
      'Möchten Sie die Option „Weiter beobachten“ entfernen?';
  ...
  String rentedesc(int availableFor, String duration) =>
      'Nach der Ausleihe haben Sie $availableFor Tage Zeit, um mit dem Ansehen zu beginnen. Nach dem Start des Streamings haben Sie $duration Stunden Zeit, um das Video zu beenden.';

  @override
  String youCanWatchThis(int duration) =>
      'Sie können diesen Inhalt während des Zeitraums von $duration Stunden mehrmals ansehen.';
  ...
  @override
  String get successfullyRentedMoviesOn => 'Erfolgreich ausgeliehene Filme auf';
  ...
  String doYouConfirmThis(String movieName) =>
      'Bestätigen Sie diesen Mietplan für $movieName';
