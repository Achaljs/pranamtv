            ...
            children: [
              AnimatedContainer(
                ...
                child: VideoPlayersComponent(
                  ...
                  hasNextEpisode: tvShowController.episodeList.length > tvShowController.currentEpisodeIndex.value + 1,
                  onWatchNow: () {
                    tvShowController.isTrailer(false);
                    if (tvShowController.selectSeason.value.episodes.first.videoUrlInput.isNotEmpty) {
                      tvShowController.selectedEpisode(tvShowController.selectSeason.value.episodes.first);
                      tvShowController.showData(VideoPlayerModel.fromJson(tvShowController.selectSeason.value.episodes.first.toJson()));
                      tvShowController.getEpisodeDetail(isWatchVideo: true);
                  ...
                  onWatchNextEpisode: () {
                    if (tvShowController.currentEpisodeIndex.value < tvShowController.episodeList.length) {
                      tvShowController.currentEpisodeIndex.value = tvShowController.currentEpisodeIndex.value + 1;
                      tvShowController.episodeList[tvShowController.currentEpisodeIndex.value];
